...
<header class="reveal" style="animation-delay:.02s">
  ...
  <p class="lead">This is my entry for the Faro Head of Data challenge: use Faro as an active trader,
     ...
     stat — and take it from an idea to a working proof of concept. I started from a question I actually
     ask intraday and worked back to the data, not the other way round.</p>
...
layer — lives in plain importable functions, so everything is unit-testable and the same code runs
whether Airflow drives it or the small runner behind the live page does. Flow:
